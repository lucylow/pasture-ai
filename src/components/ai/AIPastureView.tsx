    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-6 max-w-7xl mx-auto">
      <div className="lg:col-span-2 space-y-4">
        ...
        <div className="relative h-[500px] rounded-2xl overflow-hidden border border-slate-200 shadow-inner bg-slate-900 group">
          ...
          */}
          <div className="absolute inset-0 bg-[url('https://api.mapbox.com/styles/v1/mapbox/satellite-v9/static/150.88,-34.41,13/800x500?access_token=mock')] bg-cover bg-center opacity-60 group-hover:opacity-80 transition-opacity duration-700" />
